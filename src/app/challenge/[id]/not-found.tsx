  ...
  return (
    <div className="flex-1 flex items-center justify-center px-4">
      <div className="flex flex-col items-center text-center max-w-sm">
        <div className="flex items-center justify-center size-16 rounded-full bg-destructive/10 mb-6" aria-hidden="true">
        ...
        <h1 className="text-2xl font-bold text-foreground mb-2">Challenge introuvable</h1>
