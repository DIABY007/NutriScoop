...
export function EditParticipantForm({ participant, challengeId }: Props) {
  const action = useCallback(
    (prev: ActionState, formData: FormData) =>
      updateParticipant(participant.id, challengeId, prev, formData),
    [participant.id, challengeId]
  );
    ...
    <form action={formAction} className="flex flex-col gap-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1 flex flex-col gap-1.5">
          ...
          <input id="nom" name="nom" type="text" required maxLength={100} defaultValue={participant.nom}
        ...
        <div className="flex-1 flex flex-col gap-1.5">
          ...
          <input id="prenom" name="prenom" type="text" required maxLength={100} defaultValue={participant.prenom}
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <input id="age" name="age" type="number" required min={1} max={150} defaultValue={participant.age}
          aria-invalid={!!state.errors?.age}
          className="h-11 px-4 rounded-xl border border-input bg-surface text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-colors aria-[invalid=true]:border-destructive max-w-32"
        />
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <textarea id="objectif" name="objectif" rows={3} maxLength={500} defaultValue={participant.objectif ?? ""}
